...
#ifndef MOVE_FORWART_ROTATE_H_
#define MOVE_FORWART_ROTATE_H_
...
namespace robotis_op
{
  ...
  class MoveForwartRotate : public OPDemo
  {
  public:
    enum Stand_Status
    {
  ...
  protected:
    ...
    void komunikasimoveforwartrotateCallback(const std_msgs::Int32::ConstPtr &msg); // komunikasi
    ...
    MoveForwartRotateBallTracker move_forwart_rotate_ball_tracker_;
    MoveForwartRotateBallFollower move_forwart_rotate_ball_follower_;
    ...
    ros::Subscriber komunikasimoveforwartrotate_sub_; // komunikasi
    ...
    float comp_;
    int game_;
    int komunikasi_moveforwartrotate_;         // komunikasi
    int desired_komunikasi_moveforwartrotate_; // komunikasi
