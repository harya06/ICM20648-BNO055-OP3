...
#ifndef MOVE_FORWART_SIDE_BALL_TRACKING_H_
#define MOVE_FORWART_SIDE_BALL_TRACKING_H_
...
namespace robotis_op
{
  ...
  class MoveForwartSideBallTracker
  {
  public:
    enum TrackingStatus
    {
...
#endif /* MOVE_FORWART_SIDE_BALL_TRACKING_H_ */
