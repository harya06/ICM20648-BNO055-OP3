...
#ifndef MOVE_FORWART_SIDE_H_
#define MOVE_FORWART_SIDE_H_
...
namespace robotis_op
{
  ...
  class MoveForwartSide : public OPDemo
  {
  public:
    enum Stand_Status
    {
  ...
  protected:
    ...
    void komunikasimoveforwartsideCallback(const std_msgs::Int32::ConstPtr &msg); // komunikasi
    ...
    MoveForwartSideBallTracker move_forwart_side_ball_tracker_;
    MoveForwartSideBallFollower move_forwart_side_ball_follower_;
    ...
    ros::Subscriber komunikasimoveforwartside_sub_; // komunikasi
    ...
    float comp_;
    int game_;
    int komunikasi_moveforwartside_;         // komunikasi
    int desired_komunikasi_moveforwartside_; // komunikasi
