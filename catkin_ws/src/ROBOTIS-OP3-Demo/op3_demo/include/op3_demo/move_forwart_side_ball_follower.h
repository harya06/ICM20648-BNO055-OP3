...
#ifndef MOVE_FORWART_SIDE_BALL_FOLLOWER_H_
#define MOVE_FORWART_SIDE_BALL_FOLLOWER_H_
...
namespace robotis_op
{
  ...
  class MoveForwartSideBallFollower
  {
  public:
    enum
    {
...
#endif /* MOVE_FORWART_SIDE_BALL_FOLLOWER_H_ */
