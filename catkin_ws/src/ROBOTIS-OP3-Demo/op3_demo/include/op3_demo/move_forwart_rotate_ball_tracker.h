...
#ifndef MOVE_FORWART_ROTATE_BALL_TRACKING_H_
#define MOVE_FORWART_ROTATE_BALL_TRACKING_H_
...
namespace robotis_op
{
  ...
  class MoveForwartRotateBallTracker
  {
  public:
    enum TrackingStatus
    {
...
#endif /* MOVE_FORWART_ROTATE_BALL_TRACKING_H_ */
