...
#ifndef MOVE_FORWART_ROTATE_BALL_FOLLOWER_H_
#define MOVE_FORWART_ROTATE_BALL_FOLLOWER_H_
...
namespace robotis_op
{
  ...
  class MoveForwartRotateBallFollower
  {
  public:
    enum
    {
...
#endif /* MOVE_FORWART_ROTATE_BALL_FOLLOWER_H_ */
