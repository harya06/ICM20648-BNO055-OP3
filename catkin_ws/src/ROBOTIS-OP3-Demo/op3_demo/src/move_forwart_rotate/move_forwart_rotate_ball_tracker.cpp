...
#include "op3_demo/move_forwart_rotate_ball_tracker.h"

namespace robotis_op
{

  MoveForwartRotateBallTracker::MoveForwartRotateBallTracker()
        ...
        DEBUG_PRINT(false)
  {
    ...
    ball_position_sub_ = nh_.subscribe("/ball_detector_node/circle_set", 1, &MoveForwartRotateBallTracker::ballPositionCallback, this);
    ball_tracking_command_sub_ = nh_.subscribe("/ball_tracker/command", 1, &MoveForwartRotateBallTracker::ballTrackerCommandCallback,
                                               this);
  }
  ...
  void MoveForwartRotateBallTracker::ballPositionCallback(const op3_ball_detector::CircleSetStamped::ConstPtr &msg)
  {
  ...
  void MoveForwartRotateBallTracker::ballTrackerCommandCallback(const std_msgs::String::ConstPtr &msg)
  {
    if (msg->data == "start")
    {
      startTracking();
  ...
  void MoveForwartRotateBallTracker::startTracking()
  {
    on_tracking_ = true;
    ROS_INFO_COND(DEBUG_PRINT, "Start Ball tracking");
  }

  void MoveForwartRotateBallTracker::stopTracking()
  {
    goInit();
  ...
  void MoveForwartRotateBallTracker::setUsingHeadScan(bool use_scan)
  {
    use_head_scan_ = use_scan;
  }

  int MoveForwartRotateBallTracker::processTracking()
  {
  ...
  void MoveForwartRotateBallTracker::publishHeadJoint(double pan, double tilt)
  {
  ...
  void MoveForwartRotateBallTracker::goInit()
  {
    sensor_msgs::JointState head_angle_msg;
  ...
  void MoveForwartRotateBallTracker::scanBall()
  {
