...
namespace robotis_op
{
  ...
  MoveForwartBallTracker::MoveForwartBallTracker()
        ...
        DEBUG_PRINT(false)
  {
    ...
    ball_position_sub_ = nh_.subscribe("/ball_detector_node/circle_set", 1, &MoveForwartBallTracker::ballPositionCallback, this);
    ball_tracking_command_sub_ = nh_.subscribe("/ball_tracker/command", 1, &MoveForwartBallTracker::ballTrackerCommandCallback,
                                               this);
  }
  ...
  void MoveForwartBallTracker::ballPositionCallback(const op3_ball_detector::CircleSetStamped::ConstPtr &msg)
  {
  ...
  void MoveForwartBallTracker::ballTrackerCommandCallback(const std_msgs::String::ConstPtr &msg)
  {
    if (msg->data == "start")
    {
      startTracking();
  ...
  void MoveForwartBallTracker::startTracking()
  {
    on_tracking_ = true;
    ROS_INFO_COND(DEBUG_PRINT, "Start Ball tracking");
  }

  void MoveForwartBallTracker::stopTracking()
  {
    goInit();
  ...
  void MoveForwartBallTracker::setUsingHeadScan(bool use_scan)
  {
    use_head_scan_ = use_scan;
  }

  int MoveForwartBallTracker::processTracking()
  {
  ...
  void MoveForwartBallTracker::publishHeadJoint(double pan, double tilt)
  {
  ...
  void MoveForwartBallTracker::goInit()
  {
    sensor_msgs::JointState head_angle_msg;
  ...
  void MoveForwartBallTracker::scanBall()
  {
