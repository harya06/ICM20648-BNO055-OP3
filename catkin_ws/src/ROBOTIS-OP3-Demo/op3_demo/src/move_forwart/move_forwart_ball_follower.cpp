...
namespace robotis_op
{
  ...
  MoveForwartBallFollower::MoveForwartBallFollower()
      : nh_(ros::this_node::getName()),
        ...
        DEBUG_PRINT(false)
  {
    current_joint_states_sub_ = nh_.subscribe("/robotis/goal_joint_states", 10, &MoveForwartBallFollower::currentJointStatesCallback,
                                              this);
    chatter_sub_ = nh_.subscribe("/chatter", 10, &MoveForwartBallFollower::chatterCallback, this); // kompas
    ypr_data_sub_ = nh_.subscribe("/sensor_ypr", 1, &MoveForwartBallFollower::sensorYPRCallback, this);
    // imu_data_sub_ = nh_.subscribe("/robotis/open_cr/imu", 1, &MoveForwartBallFollower::imuDataCallback, this); //bangun
    komunikasi_sub_ = nh_.subscribe("/receive", 10, &MoveForwartBallFollower::komunikasiCallback, this); // komunikasi
  ...
  void MoveForwartBallFollower::muterkanan()
  {
  ...
  void MoveForwartBallFollower::muterkiri()
  {
  ...
  void MoveForwartBallFollower::majuReady()
  {
  ...
  void MoveForwartBallFollower::jalanTempat()
  {
  ...
  void MoveForwartBallFollower::startSet()
  {
    //  approach_ball_position_ = NotFound;
    count_to_kick_ = 0;
  ...
  void MoveForwartBallFollower::startFollowing()
  {
  ...
  void MoveForwartBallFollower::stopFollowing()
  {
    on_tracking_ = false;
    //  approach_ball_position_ = NotFound;
    count_to_kick_ = 0;
  ...
  void MoveForwartBallFollower::chatterCallback(const std_msgs::String::ConstPtr &msg) // kompas
  {
    // ROS_INFO("data kompas MoveForwartBallFollower: %s", msg->data.c_str());
    int mag = std::atoi(msg->data.c_str());
    imu = mag;
  }

  void MoveForwartBallFollower::sensorYPRCallback(const robotis_controller_msgs::SensorYPR::ConstPtr &msg)
  {
  ...
  void MoveForwartBallFollower::komunikasiCallback(const std_msgs::Int32::ConstPtr &msg)
  {
    ROS_INFO("Balasan Komunikasi BFFFFFFF: %d", msg->data);
    komunikasi = msg->data;
  }

  void MoveForwartBallFollower::currentJointStatesCallback(const sensor_msgs::JointState::ConstPtr &msg)
  {
    double pan, tilt;
    int get_count = 0;
  ...
  void MoveForwartBallFollower::calcFootstep(double target_distance, double target_angle, double delta_time,
  ...
  void MoveForwartBallFollower::calcwaitFootstep(double target_distance, double target_angle, double delta_time,
                                                 double &fb_move, double &rl_angle)
  {
    // calc rl angle
    double rl_goal = 0.0;
  ...
  bool MoveForwartBallFollower::processFollowing(double x_angle, double y_angle, double ball_size)
  {
  ...
  bool MoveForwartBallFollower::processwaitFollowing(double x_angle, double y_angle, double ball_size)
  {
    ros::Time curr_time = ros::Time::now();
    ros::Duration dur = curr_time - prev_time_;
    double delta_time = dur.nsec * 0.000000001 + dur.sec;
  ...
  void MoveForwartBallFollower::decideBallPositin(double x_angle, double y_angle)
  {
    // check of getting head joints angle
    if (current_tilt_ == -10 && current_pan_ == -10)
    {
  ...
  void MoveForwartBallFollower::firstKick()
  {
  ...
  void MoveForwartBallFollower::sendZero()
  {
    std_msgs::Int32 reply; // balasan komunikasi
    reply.data = 0;
    reply_pub_.publish(reply);
  ...
  void MoveForwartBallFollower::waitFollowing()
  {
    count_not_found_++;
  ...
  void MoveForwartBallFollower::waitFollowingLurus()
  {
    count_not_found_++;
  ...
  void MoveForwartBallFollower::waitFollowingMuter()
  {
    count_not_found_++;
  ...
  // void MoveForwartBallFollower::waitprocessFollowing()
  // {
  // //  // count_not_found_++;
  // //   // std_msgs::Int32 reply; //balasan komunikasi
  // //   // reply.data = 0;
  ...
  void MoveForwartBallFollower::setWalkingCommand(const std::string &command)
  {
    // get param
    if (command == "start")
    {
  ...
  // void MoveForwartBallFollower::imuDataCallback(const sensor_msgs::Imu::ConstPtr &msg)  //bangun
  // {
  ...
  void MoveForwartBallFollower::setWalkingParam(double x_move, double y_move, double rotation_angle, bool balance)
  {
    current_walking_param_.balance_enable = balance;
  ...
  bool MoveForwartBallFollower::getWalkingParam()
  {
