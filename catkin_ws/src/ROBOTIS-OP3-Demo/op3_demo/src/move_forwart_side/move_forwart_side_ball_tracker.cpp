...
#include "op3_demo/move_forwart_side_ball_tracker.h"

namespace robotis_op
{

  MoveForwartSideBallTracker::MoveForwartSideBallTracker()
        ...
        DEBUG_PRINT(false)
  {
    ...
    ball_position_sub_ = nh_.subscribe("/ball_detector_node/circle_set", 1, &MoveForwartSideBallTracker::ballPositionCallback, this);
    ball_tracking_command_sub_ = nh_.subscribe("/ball_tracker/command", 1, &MoveForwartSideBallTracker::ballTrackerCommandCallback,
                                               this);
  }
  ...
  void MoveForwartSideBallTracker::ballPositionCallback(const op3_ball_detector::CircleSetStamped::ConstPtr &msg)
  {
  ...
  void MoveForwartSideBallTracker::ballTrackerCommandCallback(const std_msgs::String::ConstPtr &msg)
  {
    if (msg->data == "start")
    {
      startTracking();
  ...
  void MoveForwartSideBallTracker::startTracking()
  {
    on_tracking_ = true;
    ROS_INFO_COND(DEBUG_PRINT, "Start Ball tracking");
  }

  void MoveForwartSideBallTracker::stopTracking()
  {
    goInit();
  ...
  void MoveForwartSideBallTracker::setUsingHeadScan(bool use_scan)
  {
    use_head_scan_ = use_scan;
  }

  int MoveForwartSideBallTracker::processTracking()
  {
  ...
  void MoveForwartSideBallTracker::publishHeadJoint(double pan, double tilt)
  {
  ...
  void MoveForwartSideBallTracker::goInit()
  {
    sensor_msgs::JointState head_angle_msg;
  ...
  void MoveForwartSideBallTracker::scanBall()
  {
