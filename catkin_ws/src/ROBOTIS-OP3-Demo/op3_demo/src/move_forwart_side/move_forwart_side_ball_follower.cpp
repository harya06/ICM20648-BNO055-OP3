...
#include "op3_demo/move_forwart_side_ball_follower.h"
#include <iostream>

namespace robotis_op
{

  MoveForwartSideBallFollower::MoveForwartSideBallFollower()
      : nh_(ros::this_node::getName()),
        ...
        DEBUG_PRINT(false)
  {
    current_joint_states_sub_ = nh_.subscribe("/robotis/goal_joint_states", 10, &MoveForwartSideBallFollower::currentJointStatesCallback,
                                              this);
    chatter_sub_ = nh_.subscribe("/chatter", 10, &MoveForwartSideBallFollower::chatterCallback, this); // kompas
    ypr_data_sub_ = nh_.subscribe("/sensor_ypr", 1, &MoveForwartSideBallFollower::sensorYPRCallback, this);
    // imu_data_sub_ = nh_.subscribe("/robotis/open_cr/imu", 1, &MoveForwartSideBallFollower::imuDataCallback, this); //bangun
    komunikasi_sub_ = nh_.subscribe("/receive", 10, &MoveForwartSideBallFollower::komunikasiCallback, this); // komunikasi
  ...
  void MoveForwartSideBallFollower::muterkanan()
  {
  ...
  void MoveForwartSideBallFollower::muterkiri()
  {
  ...
  void MoveForwartSideBallFollower::majuReady()
  {
  ...
  void MoveForwartSideBallFollower::jalanTempat()
  {
  ...
  void MoveForwartSideBallFollower::startSet()
  {
    //  approach_ball_position_ = NotFound;
    count_to_kick_ = 0;
  ...
  void MoveForwartSideBallFollower::startFollowing()
  {
  ...
  void MoveForwartSideBallFollower::stopFollowing()
  {
    on_tracking_ = false;
    //  approach_ball_position_ = NotFound;
    count_to_kick_ = 0;
  ...
  void MoveForwartSideBallFollower::chatterCallback(const std_msgs::String::ConstPtr &msg) // kompas
  {
    // ROS_INFO("data kompas MoveForwartSideBallFollower: %s", msg->data.c_str());
    int mag = std::atoi(msg->data.c_str());
    imu = mag;
  }

  void MoveForwartSideBallFollower::sensorYPRCallback(const robotis_controller_msgs::SensorYPR::ConstPtr &msg)
  {
  ...
  void MoveForwartSideBallFollower::komunikasiCallback(const std_msgs::Int32::ConstPtr &msg)
  {
    ROS_INFO("Balasan Komunikasi BFFFFFFF: %d", msg->data);
    komunikasi = msg->data;
  }

  void MoveForwartSideBallFollower::currentJointStatesCallback(const sensor_msgs::JointState::ConstPtr &msg)
  {
    double pan, tilt;
    int get_count = 0;
  ...
  void MoveForwartSideBallFollower::calcFootstep(double target_distance, double target_angle, double delta_time,
  ...
  void MoveForwartSideBallFollower::calcwaitFootstep(double target_distance, double target_angle, double delta_time,
                                                     double &fb_move, double &rl_angle)
  {
    // calc rl angle
    double rl_goal = 0.0;
  ...
  bool MoveForwartSideBallFollower::processFollowing(double x_angle, double y_angle, double ball_size)
  {
  ...
  bool MoveForwartSideBallFollower::processwaitFollowing(double x_angle, double y_angle, double ball_size)
  {
    ros::Time curr_time = ros::Time::now();
    ros::Duration dur = curr_time - prev_time_;
    double delta_time = dur.nsec * 0.000000001 + dur.sec;
  ...
  void MoveForwartSideBallFollower::decideBallPositin(double x_angle, double y_angle)
  {
    // check of getting head joints angle
    if (current_tilt_ == -10 && current_pan_ == -10)
    {
  ...
  void MoveForwartSideBallFollower::firstKick()
  {
  ...
  void MoveForwartSideBallFollower::sendZero()
  {
    std_msgs::Int32 reply; // balasan komunikasi
    reply.data = 0;
    reply_pub_.publish(reply);
  ...
  void MoveForwartSideBallFollower::waitFollowing()
  {
    count_not_found_++;
  ...
  void MoveForwartSideBallFollower::waitFollowingLurus()
  {
    count_not_found_++;
  ...
  void MoveForwartSideBallFollower::waitFollowingMuter()
  {
    count_not_found_++;
  ...
  // void MoveForwartSideBallFollower::waitprocessFollowing()
  // {
  // //  // count_not_found_++;
  // //   // std_msgs::Int32 reply; //balasan komunikasi
  // //   // reply.data = 0;
  ...
  void MoveForwartSideBallFollower::setWalkingCommand(const std::string &command)
  {
    // get param
    if (command == "start")
    {
  ...
  // void MoveForwartSideBallFollower::imuDataCallback(const sensor_msgs::Imu::ConstPtr &msg)  //bangun
  // {
  ...
  void MoveForwartSideBallFollower::setWalkingParam(double x_move, double y_move, double rotation_angle, bool balance)
  {
    current_walking_param_.balance_enable = balance;
  ...
  bool MoveForwartSideBallFollower::getWalkingParam()
  {
