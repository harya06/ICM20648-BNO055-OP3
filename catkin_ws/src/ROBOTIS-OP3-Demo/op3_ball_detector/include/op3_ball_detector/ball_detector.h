...
//tambahan
#include <std_msgs/Float64.h> // Include std_msgs/Float64 for receiving center_x
...
class BallDetector
{
 ...
 protected:
  ...
  //tambahan
  void circlesCallback(const std_msgs::Float64::ConstPtr& center_x_msg);
